...
function cari($keyword){
    $query = "SELECT * FROM tb_ujian WHERE nama_mapel LIKE '%$keyword%' OR  jurusan LIKE '%$keyword%' OR kelas LIKE '%$keyword%' OR tanggal_ujian LIKE '%$keyword%' OR durasi_ujian LIKE '%$keyword%'";
    return query($query);
}
?>